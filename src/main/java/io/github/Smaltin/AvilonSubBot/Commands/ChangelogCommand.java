...
public class ChangelogCommand extends AbstractCommand {
    ...
    public void runCommand(JDA client, MessageReceivedEvent event, Message msg) {
        ...
        ArrayList<String> sortedList = new ArrayList<>(clogs.keySet()); Collections.sort(sortedList);
        for (String key : sortedList) { changelog.addField(key, clogs.get(key), false); }
