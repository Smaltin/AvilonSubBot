package io.github.Smaltin.AvilonSubBot.MusicUtilities;
...
public class MusicUtilities {
    ...
    /**
     * Gets the Music Manager by passing in the guild
     *
     * @param guild the guild the bot is being used in
     * @return the {@link GuildMusicManager} used on the {@link Guild}
     */
    ...
    private static void play(Guild guild, GuildMusicManager musicManager, AudioTrack track) {
        MusicUtilities.connectToFirstVoiceChannel(guild.getAudioManager());
